      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8 rtl:space-x-reverse rtl:space-x-10">
            ...
            <a href="#experience" className="text-gray-600 hover:text-gray-900 transition-colors font-medium">{t('header.experience')}</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-100">
            <div className="px-2 pt-2 pb-3 space-y-2 bg-white">
              ...
              <a href="#experience" className="block px-3 py-2 text-gray-600 hover:text-gray-900 font-medium">{t('header.experience')}</a>
